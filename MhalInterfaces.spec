...
%{_libdir}/libMhalInterface.*
%{_libdir}/pkgconfig/MhalInterface.pc
%{_prefix}/lib/python/redhawk/MhalInterface
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/MhalInterface-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/MHALInterface.jar
%{_prefix}/lib/MHALInterface.src.jar
%endif
